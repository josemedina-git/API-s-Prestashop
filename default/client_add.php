                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                        <form action="post_client.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small class="form-text text-muted">Introduce el ID del grupo (por defecto, 3 para Clientes).</small>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group form-check">
                                                ...
                                                <label class="form-check-label" for="newsletter">Boletín</label>
                                            </div>
                                            <div class="form-group form-check">
                                                <input type="checkbox" name="partner_offers" class="form-check-input" id="partner_offers">
                                                <label class="form-check-label" for="partner_offers">Ofertas de asociados</label>
                                            </div>
                                            <button type="submit" class="btn btn-primary">Agregar Cliente</button>
                                            <a href="tbl_clients.php" class="btn btn-secondary">Cancelar</a>
                                        </form>
                                        </div>
                                    </div>
                                </div>
