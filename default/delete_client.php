...
if (isset($_GET['id'])) {
    ...
    // Puedes verificar el código de estado HTTP de la respuesta si es necesario
} else {
    echo "No se ha proporcionado un ID.";
}

// Redirige de nuevo a la página de clientes después de un segundo
header("refresh:1;url=tbl_clients.php");
exit;
?>
